          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="col-span-2">
              ...
              <input
                ...
                className={clsx(
                  'block w-full py-2 px-3 rounded-md border border-gray-300 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 sm:text-sm',
                  {
                    'focus:border-red-500 focus:ring-red-500': Boolean(
                      errors.address,
                    ),
                  },
                )}
